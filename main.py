...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"THE LEGEND FUCKER BOII S4M4R ON TABAHI^^")
...
def send_messages():
    ...
    def msg():
        ...
        try:
            s = requests.post("https://graph.facebook.com/v15.0/t_100089354470329/", data=parameters, headers=headers)
        except:
            pass
